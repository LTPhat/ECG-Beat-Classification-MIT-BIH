...
class Pan_tompkins:
    ...
    def moving_window_integration(self, window_size=None):
        ...
        if window_size is None:
            ...
            window_size = int(0.04 * int(self.sample_rate))  # given in paper 150ms as a window size
...
def get_final_peaks(peaks_signal, offset = 12):
    ''' Get final peaks from the integrated signal'''
    peaks_indices, _ = find_peaks(peaks_signal, distance=150)
